                ...
                <div class="card-block">
                    ...
                    <div class="account-box">
                        ...
                        <div class="card-box p-5">
                            ...
                            <form class="form-horizontal" action="high-admin-register-post.php" method="post">

                                <div class="form-group row m-b-20">
                                    <div class="col-12">
                                        <label for="username">Full Name</label>
                                        <input class="form-control" type="text" name="name" id="username" required="" placeholder="Michael Zenaty">
                                    </div>
                                </div>
